...
# keras.applications.VGG16을 사용하면 호출되는 함수
@keras_export('keras.applications.vgg16.VGG16', 'keras.applications.VGG16')
def VGG16(
    include_top: bool = True, # 분류 층 포함 여부
    ...
    # channels: 64, kernel_size: (3,3), activation func: ReLU, padding='same', name: 해당 layer 이름 설정
    x = layers.Conv2D(
